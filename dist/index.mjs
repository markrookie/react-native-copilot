...
var Button = (_a) => {
  ...
  return /* @__PURE__ */ React.createElement(View, { style: [styles.button, wrapperStyle], pointerEvents: "none" }, /* @__PURE__ */ React.createElement(Text, __spreadValues({ style: [styles.buttonText, style] }, rest)));
};
...
var Tooltip = ({ labels }) => {
  ...
  return /* @__PURE__ */ React2.createElement(View2, null, /* @__PURE__ */ React2.createElement(View2, { style: styles.tooltipContainer }, /* @__PURE__ */ React2.createElement(Text2, { testID: "stepDescription", style: styles.tooltipText }, currentStep == null ? void 0 : currentStep.text)), /* @__PURE__ */ React2.createElement(View2, { style: [styles.bottomBar] }, !isLastStep ? /* @__PURE__ */ React2.createElement(TouchableOpacity, { onPress: handleStop, testID: "tooltip-skip-button" }, /* @__PURE__ */ React2.createElement(Button, null, labels.skip)) : null, !isFirstStep ? /* @__PURE__ */ React2.createElement(TouchableOpacity, { onPress: handlePrev, testID: "tooltip-previous-button" }, /* @__PURE__ */ React2.createElement(Button, null, labels.previous)) : null, !isLastStep ? /* @__PURE__ */ React2.createElement(TouchableOpacity, { onPress: handleNext, testID: "tooltip-next-button" }, /* @__PURE__ */ React2.createElement(Button, null, labels.next)) : /* @__PURE__ */ React2.createElement(TouchableOpacity, { onPress: handleStop, testID: "tooltip-finish-button" }, /* @__PURE__ */ React2.createElement(Button, null, labels.finish))));
};
