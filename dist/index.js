...
var Button = (_a) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_react_native2.View, { style: [styles.button, wrapperStyle], pointerEvents: "none" }, /* @__PURE__ */ import_react.default.createElement(import_react_native2.Text, __spreadValues({ style: [styles.buttonText, style] }, rest)));
};
...
var Tooltip = ({ labels }) => {
  ...
  return /* @__PURE__ */ import_react2.default.createElement(import_react_native3.View, null, /* @__PURE__ */ import_react2.default.createElement(import_react_native3.View, { style: styles.tooltipContainer }, /* @__PURE__ */ import_react2.default.createElement(import_react_native3.Text, { testID: "stepDescription", style: styles.tooltipText }, currentStep == null ? void 0 : currentStep.text)), /* @__PURE__ */ import_react2.default.createElement(import_react_native3.View, { style: [styles.bottomBar] }, !isLastStep ? /* @__PURE__ */ import_react2.default.createElement(import_react_native3.TouchableOpacity, { onPress: handleStop, testID: "tooltip-skip-button" }, /* @__PURE__ */ import_react2.default.createElement(Button, null, labels.skip)) : null, !isFirstStep ? /* @__PURE__ */ import_react2.default.createElement(import_react_native3.TouchableOpacity, { onPress: handlePrev, testID: "tooltip-previous-button" }, /* @__PURE__ */ import_react2.default.createElement(Button, null, labels.previous)) : null, !isLastStep ? /* @__PURE__ */ import_react2.default.createElement(import_react_native3.TouchableOpacity, { onPress: handleNext, testID: "tooltip-next-button" }, /* @__PURE__ */ import_react2.default.createElement(Button, null, labels.next)) : /* @__PURE__ */ import_react2.default.createElement(import_react_native3.TouchableOpacity, { onPress: handleStop, testID: "tooltip-finish-button" }, /* @__PURE__ */ import_react2.default.createElement(Button, null, labels.finish))));
};
